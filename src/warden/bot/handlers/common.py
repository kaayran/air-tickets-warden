...
HELP_TEXT = (
    ...
    "Доступные команды:\n"
    "/new — создать подписку: выбор аэропортов кнопками + календарь\n"
    "/list — список подписок с кнопками управления (пауза / удаление)\n"
    ...
    "/help — эта справка\n\n"
    "Управление подписками работает. Реальный поиск цен и алерты появятся в следующих версиях."
)
